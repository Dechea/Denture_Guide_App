...
function Root48Left({ children, customStyles }: RootProps) {
  ...
  return (
    <View
      ...
      aspectRatio={17 / 39}
      position='absolute'
      className={cx('left-[3.225%] -top-[12%]', customStyles)}
    >
      <svg
        width='100%'
        viewBox='0 0 17 39'
...
export default withEnable(Root48Left);
