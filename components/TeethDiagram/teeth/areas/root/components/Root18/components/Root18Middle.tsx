...
function Root18Middle({ children, customStyles }: RootProps) {
  ...
  return (
    <View
      ...
      aspectRatio={13 / 36}
      position='absolute'
      className={cx('left-1/2 -translate-x-1/2 -bottom-[6%]', customStyles)}
    >
      <svg
        width='100%'
        viewBox='0 0 13 36'
...
export default withEnable(Root18Middle);
