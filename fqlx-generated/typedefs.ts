...
export interface TsMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Ts) => boolean) | string
  ): FirstWhereMethods<Ts>;
}
...
export interface PatientFileMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: PatientFile) => boolean) | string
  ): FirstWhereMethods<PatientFile>;
}
...
export interface PatientMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Patient) => boolean) | string
  ): FirstWhereMethods<Patient>;
}
...
export interface RootMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Root) => boolean) | string
  ): FirstWhereMethods<Root>;
}
...
export interface CrownMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Crown) => boolean) | string
  ): FirstWhereMethods<Crown>;
}
...
export interface ToothMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Tooth) => boolean) | string
  ): FirstWhereMethods<Tooth>;
}
...
export interface BodyPartLeafMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: BodyPartLeaf) => boolean) | string
  ): FirstWhereMethods<BodyPartLeaf>;
}
...
export interface FindingMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Finding) => boolean) | string
  ): FirstWhereMethods<Finding>;
}
...
export interface TreatmentDocMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: TreatmentDoc) => boolean) | string
  ): FirstWhereMethods<TreatmentDoc>;
}
...
export interface SelectedProductMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: SelectedProduct) => boolean) | string
  ): FirstWhereMethods<SelectedProduct>;
}
...
export interface PriceMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Price) => boolean) | string
  ): FirstWhereMethods<Price>;
}
...
export interface ProductLocalizationMethods {
   ...
   */
  create(
    input: ProductLocalizationInput | string
  ): CreateMethods<ProductLocalization>;
   ...
   */
  firstWhere(
    inputCondition: ((data: ProductLocalization) => boolean) | string
  ): FirstWhereMethods<ProductLocalization>;
}
...
export interface ManufacturerMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Manufacturer) => boolean) | string
  ): FirstWhereMethods<Manufacturer>;
}
...
export interface ImplantMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Implant) => boolean) | string
  ): FirstWhereMethods<Implant>;
}
...
export interface AbutmentMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Abutment) => boolean) | string
  ): FirstWhereMethods<Abutment>;
}
...
export interface HealingAbutmentMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: HealingAbutment) => boolean) | string
  ): FirstWhereMethods<HealingAbutment>;
}
...
export interface TemporaryAbutmentMethods {
   ...
   */
  create(
    input: TemporaryAbutmentInput | string
  ): CreateMethods<TemporaryAbutment>;
   ...
   */
  firstWhere(
    inputCondition: ((data: TemporaryAbutment) => boolean) | string
  ): FirstWhereMethods<TemporaryAbutment>;
}
...
export interface ImpressionMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Impression) => boolean) | string
  ): FirstWhereMethods<Impression>;
}
...
export interface LabScrewMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: LabScrew) => boolean) | string
  ): FirstWhereMethods<LabScrew>;
}
...
export interface ImplantReplicaMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: ImplantReplica) => boolean) | string
  ): FirstWhereMethods<ImplantReplica>;
}
...
export interface ScrewdriverMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Screwdriver) => boolean) | string
  ): FirstWhereMethods<Screwdriver>;
}
...
export interface OrientationAidMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: OrientationAid) => boolean) | string
  ): FirstWhereMethods<OrientationAid>;
}
...
export interface ProtectionAidMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: ProtectionAid) => boolean) | string
  ): FirstWhereMethods<ProtectionAid>;
}
...
export interface ClampingAidMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: ClampingAid) => boolean) | string
  ): FirstWhereMethods<ClampingAid>;
}
...
export interface ProductMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Product) => boolean) | string
  ): FirstWhereMethods<Product>;
}
...
export interface TreatmentGroupMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: TreatmentGroup) => boolean) | string
  ): FirstWhereMethods<TreatmentGroup>;
}
...
export interface TreatmentMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Treatment) => boolean) | string
  ): FirstWhereMethods<Treatment>;
}
...
export interface AreaMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Area) => boolean) | string
  ): FirstWhereMethods<Area>;
}
...
export interface TreatmentLocalizationMethods {
   ...
   */
  create(
    input: TreatmentLocalizationInput | string
  ): CreateMethods<TreatmentLocalization>;
  ...
  byId(
    id: string
  ): ByIdMethods<TreatmentLocalization, TreatmentLocalizationInput>;
   ...
   */
  firstWhere(
    inputCondition: ((data: TreatmentLocalization) => boolean) | string
  ): FirstWhereMethods<TreatmentLocalization>;
}
...
export interface AddressMethods {
   ...
   */
  firstWhere(
    inputCondition: ((data: Address) => boolean) | string
  ): FirstWhereMethods<Address>;
}
